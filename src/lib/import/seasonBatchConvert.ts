...
export const PROSPI_BATTER_SEASON_COLUMNS: BatchColumnDef[] = [
  ...
  { key: "hrStreak", label: "連本試合", minWidth: 64 },
  { key: "paHrStreak", label: "連打席本", minWidth: 64 },
  { key: "abHitStreak", label: "連打数安", minWidth: 64 },
  { key: "pinchHr", label: "代打本塁打", minWidth: 72 },
...
export function rowToBatterCounting(row: SeasonBatchPlayerRow): BatterCountingInput {
  return {
    ...
    hrStreak: optNum(row, "hrStreak"),
    paHrStreak: optNum(row, "paHrStreak"),
    abHitStreak: optNum(row, "abHitStreak"),
    pinchHr: optNum(row, "pinchHr"),
